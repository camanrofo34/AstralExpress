...
public class Train implements Serializable {
    ...
    public ChargeVagon getChargeVagon(String idVagon) {
        for (int i = 0; i < chargeVagon.size(); i++) {
            if (chargeVagon.get(i).getIdVagon().equals(idVagon)){
                return chargeVagon.get(i);
            }
        }
        return null;
    }
    ...
    public PassengerVagon getPassengerVagon(String idVagon) {
        for (int i = 0; i < passengersVagon.size(); i++) {
            if (passengersVagon.get(i).getIdVagon().equals(idVagon)){
                return passengersVagon.get(i);
            }
        }
        return null;
    }
    ...
    public String buyStandardTicket() {
        for (int i = 0; i < passengersVagon.size(); i++) {
            if (passengersVagon.get(i).buyStandard()){
                return passengersVagon.get(i).getIdVagon();
            }
        }
        return "";
    }

    public String buyExecutiveTicket() {
        for (int i = 0; i < passengersVagon.size(); i++) {
            if (passengersVagon.get(i).buyExecutive()){
                return passengersVagon.get(i).getIdVagon();
            }
        }
        return "";
    ...
    public String buyPremiumTicket() {
        for (int i = 0; i < passengersVagon.size(); i++) {
            if (passengersVagon.get(i).buyPremium()){
                return passengersVagon.get(i).getIdVagon();
            }
        }
        return "";
    ...
    public String addCharge(){
        for (int i = 0; i < chargeVagon.size(); i++) {
            if (chargeVagon.get(i).addLuggage()){
                return chargeVagon.get(i).getIdVagon();
            }
        }
        return "";
    }
