 ...
 * @author USUARIO
 */
public class LoginJwing extends javax.swing.JFrame {

    /**
     * Creates new form LoginJwing
     */
    public LoginJwing() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginJwing.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LoginJwing().setVisible(true);
            }
        });
    }
